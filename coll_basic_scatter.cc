...
int
mca_coll_yhccl_scatter_test(const void *sbuf, int scount,
...
{
    std::cout << "std::cout  mca_coll_yhccl_scatter **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 */
int
mca_coll_yhccl_scatter_inter(const void *sbuf, int scount,
                             struct ompi_datatype_t *sdtype,
                             void *rbuf, int rcount,
                             struct ompi_datatype_t *rdtype,
                             int root, struct ompi_communicator_t *comm,
