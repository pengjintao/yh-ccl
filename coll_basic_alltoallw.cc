...
int
mca_coll_yhccl_alltoallw_test(const void *sbuf, const int *scounts, const int *sdisps,
...
{
    std::cout << "std::cout  mca_coll_yhccl_alltoallw **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 */
static int
mca_coll_yhccl_alltoallw_intra_inplace(const void *rbuf, const int *rcounts, const int *rdisps,
                                       struct ompi_datatype_t * const *rdtypes,
                                       struct ompi_communicator_t *comm,
                                       mca_coll_base_module_t *module)
{
    ...
    tmp_buffer = (char*)calloc (max_size, 1);
    if (NULL == tmp_buffer) {
 ...
 */
int
mca_coll_yhccl_alltoallw_intra(const void *sbuf, const int *scounts, const int *sdisps,
                               struct ompi_datatype_t * const *sdtypes,
                               void *rbuf, const int *rcounts, const int *rdisps,
                               struct ompi_datatype_t * const *rdtypes,
                               struct ompi_communicator_t *comm,
                               mca_coll_base_module_t *module)
{
    ...
    if (MPI_IN_PLACE == sbuf) {
        return mca_coll_yhccl_alltoallw_intra_inplace (rbuf, rcounts, rdisps,
                                                       rdtypes, comm, module);
    }
 ...
 */
int
mca_coll_yhccl_alltoallw_inter(const void *sbuf, const int *scounts, const int *sdisps,
                               struct ompi_datatype_t * const *sdtypes,
                               void *rbuf, const int *rcounts, const int *rdisps,
                               struct ompi_datatype_t * const *rdtypes,
                               struct ompi_communicator_t *comm,
