...
int
mca_coll_yhccl_scatterv_test(const void *sbuf, const int *scounts,
...
{
    std::cout << "std::cout  mca_coll_yhccl_scatterv **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 */
int
mca_coll_yhccl_scatterv_intra(const void *sbuf, const int *scounts,
                              const int *disps, struct ompi_datatype_t *sdtype,
                              void *rbuf, int rcount,
                              struct ompi_datatype_t *rdtype, int root,
                              struct ompi_communicator_t *comm,
 ...
 */
int
mca_coll_yhccl_scatterv_inter(const void *sbuf, const int *scounts,
                              const int *disps, struct ompi_datatype_t *sdtype,
                              void *rbuf, int rcount,
                              struct ompi_datatype_t *rdtype, int root,
                              struct ompi_communicator_t *comm,
