...
int
mca_coll_yhccl_gatherv_test(const void *sbuf, int scount,
...
{
    std::cout << "std::cout  mca_coll_yhccl_gatherv **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 *	gatherv_intra
 *
 *	Function:	- yhccl gatherv operation
 *	Accepts:	- same arguments as MPI_Gatherv()
 *	Returns:	- MPI_SUCCESS or error code
 */
int
mca_coll_yhccl_gatherv_intra(const void *sbuf, int scount,
                             struct ompi_datatype_t *sdtype,
                             void *rbuf, const int *rcounts, const int *disps,
                             struct ompi_datatype_t *rdtype, int root,
                             struct ompi_communicator_t *comm,
 ...
 */
int
mca_coll_yhccl_gatherv_inter(const void *sbuf, int scount,
                             struct ompi_datatype_t *sdtype,
                             void *rbuf, const int *rcounts, const int *disps,
                             struct ompi_datatype_t *rdtype, int root,
                             struct ompi_communicator_t *comm,
