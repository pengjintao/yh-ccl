...
int
mca_coll_yhccl_barrier_test(struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module)
{
    std::cout << "std::cout  mca_coll_yhccl_barrier **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 */
int
mca_coll_yhccl_barrier_intra_log(struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module)
{
    int i;
    int err;
...
//     std::cout << "std::cout  mca_coll_yhccl_barrier_intra_log" << std::endl;
 ...
 */
int
mca_coll_yhccl_barrier_inter_lin(struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module)
{
    int rank;
    int result;
//     std::cout << "std::cout  mca_coll_yhccl_barrier_inter_lin" << std::endl;
