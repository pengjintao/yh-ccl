...
int
mca_coll_yhccl_allgather_test(const void *sbuf, int scount,
...
{
    std::cout << "std::cout  mca_coll_yhccl_allgather **** test" << std::endl;
    return OMPI_SUCCESS;
}
 ...
 */
int
mca_coll_yhccl_allgather_inter(const void *sbuf, int scount,
                               struct ompi_datatype_t *sdtype,
                               void *rbuf, int rcount,
                               struct ompi_datatype_t *rdtype,
                               struct ompi_communicator_t *comm,
                               mca_coll_base_module_t *module)
{
    // std::cout << "std::cout  mca_coll_yhccl_allgather_inter" << std::endl;
