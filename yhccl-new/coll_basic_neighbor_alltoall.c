 ...
 */
static int
mca_coll_yhccl_neighbor_alltoall_cart(const void *sbuf, int scount, struct ompi_datatype_t *sdtype, void *rbuf,
...
static int
mca_coll_yhccl_neighbor_alltoall_graph(const void *sbuf, int scount, struct ompi_datatype_t *sdtype, void *rbuf,
                                       int rcount, struct ompi_datatype_t *rdtype, struct ompi_communicator_t *comm,
                                       mca_coll_base_module_t *module)
{
...
static int
mca_coll_yhccl_neighbor_alltoall_dist_graph(const void *sbuf, int scount,struct ompi_datatype_t *sdtype, void *rbuf,
                                            int rcount, struct ompi_datatype_t *rdtype, struct ompi_communicator_t *comm,
                                            mca_coll_base_module_t *module)
{
                                     ...
                                     mca_coll_base_module_t *module)
{
    ...
    if (OMPI_COMM_IS_CART(comm)) {
        return mca_coll_yhccl_neighbor_alltoall_cart (sbuf, scount, sdtype, rbuf,
                                                      rcount, rdtype, comm, module);
    } else if (OMPI_COMM_IS_GRAPH(comm)) {
        return mca_coll_yhccl_neighbor_alltoall_graph (sbuf, scount, sdtype, rbuf,
                                                       rcount, rdtype, comm, module);
    } else if (OMPI_COMM_IS_DIST_GRAPH(comm)) {
        return mca_coll_yhccl_neighbor_alltoall_dist_graph (sbuf, scount, sdtype, rbuf,
                                                            rcount, rdtype, comm, module);
    }
