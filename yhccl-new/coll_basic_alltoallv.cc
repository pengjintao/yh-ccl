...
int
mca_coll_yhccl_alltoallv_test(const void *sbuf, const int *scounts, const int *sdisps,
...
{
    std::cout << "std::cout  mca_coll_yhccl_alltoallv **** test" << std::endl;
    return OMPI_SUCCESS;      
}                             
 ...
 */
int
mca_coll_yhccl_alltoallv_inter(const void *sbuf, const int *scounts, const int *sdisps,
                               struct ompi_datatype_t *sdtype, void *rbuf,
                               const int *rcounts, const int *rdisps,
                               struct ompi_datatype_t *rdtype,
                               struct ompi_communicator_t *comm,
